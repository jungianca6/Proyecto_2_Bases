namespace GymTEC.Data_input_models.manage_search
{
    public class Data_input_search_class
    {
        ...
        public string start_time { get; set; }          // Fecha de inicio de búsqueda (formato yyyy-MM-dd)
        public string end_time { get; set; }            // Fecha de fin de búsqueda (formato yyyy-MM-dd)
    }
}
